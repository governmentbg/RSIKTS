...
namespace DataAccess.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("ALTER DATABASE votingregister CHARACTER SET utf16 COLLATE utf16_unicode_ci");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IM1 = table.Column<string>(maxLength: 25, nullable: true),
                    IM2 = table.Column<string>(maxLength: 15, nullable: true),
                    IM3 = table.Column<string>(maxLength: 25, nullable: true),
                    ...
                    OBL = table.Column<string>(maxLength: 2, nullable: true),
                    OBS = table.Column<string>(maxLength: 4, nullable: true),
                    RAJ = table.Column<string>(maxLength: 2, nullable: true),
                    NAS = table.Column<string>(maxLength: 5, nullable: true),
                    ULKOD = table.Column<string>(maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adm_rajon = table.Column<string>(maxLength: 4, nullable: true),
                    User_account = table.Column<string>(maxLength: 30, nullable: true),
                    Koga = table.Column<DateTimeOffset>(nullable: false),
                    EGN_LICE_obr = table.Column<string>(maxLength: 10, nullable: true),
                    Sekcia = table.Column<string>(maxLength: 3, nullable: true),
                    Kod_Obrabotka = table.Column<string>(maxLength: 4, nullable: true),
                    Ime_Obrabotka = table.Column<string>(maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nkod = table.Column<string>(maxLength: 5, nullable: true),
                    nime = table.Column<string>(maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_wnuli", x => x.NREC);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    kodnsm = table.Column<string>(maxLength: 5, nullable: true),
                    Kme = table.Column<string>(unicode: true, maxLength: 7, nullable: true, defaultValueSql: "'НЕ'"),
                    JK_KV = table.Column<string>(maxLength: 2, nullable: true),
                    ULKOD = table.Column<string>(maxLength: 5, nullable: true),
