namespace Common.ViewModels.Lica
{
    ...
    public class LicaEditViewModel
    {
        ...
        [Display(Name = "Ще замества")]
        [RangeIf("JeZamestva", true, 1, Int32.MaxValue)]
        public int IdLiceZamestvan2 { get; set; }
        ...
        public bool isSikActive { get; set; }
        ...
        public List<SelectListItem> AllLicaFromPartia { get; set; }
    }
}
